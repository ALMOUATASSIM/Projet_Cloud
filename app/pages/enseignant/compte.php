...
<?php 
  function Exist($con) {
            ...
            EXCEPT 
            SELECT nom FROM enseignant WHERE id=".$_POST['id']);
...
<?php
            ...
            if(isset($_POST['update'])){
                if($_SESSION['qui'] == 'Fonctionnaire' || $_SESSION['qui'] == 'Enseignant') {
                    ...
                    if(Exist($connection,$id,$email,$tel,$ppr)){
                        echo "<div class='err'> Le PPR ou l'Email ou le Téléphone déja existe </div>";
                    }else { 
                        $sql = 'UPDATE enseignant SET email= :email, tel= :tel, password= :password WHERE ppr= :id ';
               
                  if(getPass2($_SESSION['id'],$connection) == $a_password) {
                      try{
        ...
        <div class="signin">
            ...
            <form method="post" action="compte.php">
              ...
              <table style="margin: 0 auto;">
                  ...
                  <input type="hidden" value="<?php echo $row['ppr']; ?>" name="ppr">
                    ...
                    <tr>
                        ...
                        <td> 
                            <input type="text" name="ppr" placeholder="Votre PPR" value="<?php echo $row['ppr']; ?>" disabled>
                        </td>
                    </tr>  
                 <?php   }  ?>
                    <tr>
