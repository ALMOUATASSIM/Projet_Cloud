...
//cette page afficher tous les enseigants qui sont accepter et ont l'autorité de ce connecté
...
<html>
    ...
    <?php
        $sql = 'SELECT id,nom, pnom, email, tel, ppr FROM enseignant WHERE qui = "Enseignant" AND demande = 1';
    ...
    <body>
        ...
        <div class="fonct">
            <form action="enseig.php" method="post">
                <table class="user">
                <tr>
                    <th>ID</th>
                    <th>Nom</th>
                ...
                <tr>
                    ...
                    <td style="padding:0;margin:0" colspan='2'>
                        ...
                        <button type="submit" name="delet" onClick="supp(<?php echo $row[0]; ?>)" class="button-8">Supprimer</button>
                    </td>
                </tr>
                <?php }} else { ?>
                    <tr>
                        <th colspan="6">Aucun enseignant existe</th>
                    </tr>
                    <?php } ?>
        ...
        <script>
            function modif(id)
            {
                if(confirm("Vous voulez modifier ?")){
                    window.location.href='modens.php?id=' +id+'';
                    return true;
                }
                else {
                    return false;
            ...
            function supp(id)
            {
                if(confirm("Vous voulez supprimer ?")){
                    window.location.href='deleteens.php?id=' +id+'';
                    return true;
                }
                else {
                    return false;
