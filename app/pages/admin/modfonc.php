  ...
  <?php
    ...
    <body>
        ...
        <div class="modif" style="margin: 10px auto;">
            <h1 style="text-align:center;">Modifier un fonctionnaire</h1><br>
            <form method="post">
                <table style="margin: 10px auto;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="ppr" value="<?php echo $row[5]; ?>" required></td>
                    </tr>
                    <tr>
                        <td><label>Mot de passe : </label></td>
                        <td><input type="text" name="password" value="<?php echo $row[6]; ?>" required></td>
                    </tr>
